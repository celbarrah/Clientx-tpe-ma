...
const SOCIAL = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/AgenceDigitaleWebeuz",
    icon: (
  ...
  {
    label: "X / Twitter",
    href: "https://x.com/webeuz_agency",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/webeuz",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@WebeuzDigitalPerformanceAgency",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/webeuzagency",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
  return (
    <footer>
      ...
      <div className="bg-[#f0f0ee] py-8 px-6">
          ...
          <div className="flex items-center gap-3">
            {SOCIAL.map(({ label, href, icon }) => (
              <a
                ...
                className="w-9 h-9 rounded-full bg-[#111] flex items-center justify-center text-white hover:bg-[#32DC32] hover:text-black transition-colors"
              >
                {icon}
              </a>
            ))}
